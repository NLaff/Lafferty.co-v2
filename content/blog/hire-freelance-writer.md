...
title = "How To Hire A Great Writer Quickly and Easily"
date = "2021-01-23"
description = "Finding a professional writer for my business was surprisingly easy. Here's exactly what I did."
draft = false
tags = ["writing"]
showtoc = true
tocopen = true
...
## Don't Use Upwork
First a note on **where not** to find writers.
...
![Upwork Writers](/uploads/upwork.png)
...
The best webiste I've used to find writers online is **[ProBlogger](https://problogger.com/jobs)**. 
...
1. It keeps me accountable (if I'm paying someone I need to take this seriously)
2. He's a better writer than me
...
{{< button "https://www.notion.so/nicklafferty/Writing-For-NickLafferty-com-faa9125b110d4db5b46df9a2df8274d1" "Download My Freelance Writing Guide Here" >}}
...
{{< button "https://forms.gle/NJMyVyzg2aSow2td9" "Get my freelance writing job application template." >}}


### 3. Post on a job board
I used [ProBlogger](https://www.problogger.com/jobs) and was happy with the results.
...
Here's how I navigated that with my freelancer:
| I'm also happy to introduce myself over a short Google Hangouts call if you're comfortable with that. Not everyone is so feel free to decline.
