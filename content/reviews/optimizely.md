...
Want to know how much it costs? View [Optimizely Pricing](#optimizely-pricing).
...
Hey, I'm Nick, and I do this shit for a living. For the past 7 years I've worked as a professional digital marketer for brands like Modernize, Mailgun, Mailjet, Osmosis, PhoneBurner, and Jotform.

I've actively used Optimizely, and it's competitors VWO and Google Optimize, as part of my full-time job.
...
A/B testing is a form of experimentation that compares two versions of something against each other. It's also known as split testing. In digital marketing, A/B testing is most commonly associated with testing two versions of a webpage.
...
## AB Testing Tools for Websites
The 3 most common website testing tools are:
1. [Optimizely](https://www.optimizely.com/)
2. [Visual Website Optimizer (VWO)](https://vwo.com/)
3. [Google Optimize](https://optimize.google.com/optimize/home/)

## How Much Traffic Do You Need For AB Testing?
At a minimum your webpage needs 500 visitors/day, which is about 15,000 visitors/month.

Not 500 visitors to your entire site, but 500 visitors to a specific page on your website every day.

![VWO AB Test Duration Calculator](/uploads/vwo_calculator.png)

That number assumes two things:
1. Your test will run for at least 30 days.
2. The minimum improvement in conversion rate you want to see is 10%.

If you want to assume different numbers, plug them into this [ab testing duration calculator](https://vwo.com/tools/ab-test-duration-calculator/).
...
You're spending [millions on Google Ads](https://nicklafferty.com/blog/i-spent-6-million-on-google-ads-last-year-here-s-what-i-learned/) each month. You've been converting that traffic at 10%.
...
### Minimum Conversion Improvement
...
## Optimizely Review
![Optimizely Homepage Screenshot](/uploads/optimizely.png)
...
1. Fill out a form
2. Talk to an SDR so they can qualify you
3. Talk to an AE so they can ask you the exact same questions as the SDR
4. Get a demo from the AE but they won't discuss pricing
5. Another 30 minute call where pricing is discussed at the end
...
Here are two great Optimizely alternatives. 

### Optimizely vs VWO
![Optimizely vs VWO Screenshot](/uploads/vwo.png)
VWO is a somewhat cost-effective alternative to Optimizely.

VWO costs about $30k/year.
...
![VWO Frequently Used Goals](/uploads/vwo_goals.png)

VWO's implementation is more complex. You can only create custom conversions inside an individual test. You can assign the custom conversions to other tests, but you have to scroll through a cumbersome list of 'Frequently Used Goals'. 

### Optimizely vs Google Optimize
![Google Optimize Homepage](/uploads/google_optimize.png)

Here's where Google Optimize wins against Optimizely: **it's free**. 
...
Google Optimize is free. It's a freaking great free tool.
