+++
date = "2021-06-29"
description = "6sense is an ABM platform powered by AI that helps drive demand and generate revenue for your business."
tags = ["reviews", "marketing"]
title = "6Sense Review | ABM Platform Comparisons [2021 Review]"
showtoc = true
tocopen = true
affiliate = false
draft = false
...
[6sense](https://click.nicklafferty.com/6sense) is an account-based marketing platform that helps companies market and sell to their target accounts. 

6sense is headquartered in San Francisco, California and has almost 500 employees. They raised a [$125 million Series D](https://venturebeat.com/2021/03/30/6sense-which-uses-ai-to-power-account-engagement-raises-125m/) investment in March 2021 at a $2.1 billion valuation.
...
![6sense predictive model](/uploads/6sense_buyingstage.png)
...
![6sense Features](/uploads/6sense_feature_screenshot.png)
...
Once configured, accounts can enter and exit a segment automatically. This is one of the most valuable features for ABM platforms, because otherwise you have to build and maintain these segments automatically.
...
1. Manual upload
2. Sync an account list or report from Salesforce/Hubspot
3. Select filters

![6sense Create Segment](/uploads/6sense_segment_create.png)
...
![6sense Segment Filters](/uploads/6sense_segment_filters.png)
